...
#define MODEM_RX_RX2        16 // 32 // 32 Both Input and Output are OK. // Confirmed. Connected to Hardware TX pin of the SIM900 module.
#define MODEM_TX_TX2        17 // 33 // 33 Both Input and Output are OK. // Confirmed. Connected to Hardware RX pin of the SIM900 module.
//
...
//
#define RXD_GPS             27 //16 // 16 Both Input and Output OK ////13 // Confirmed. Connected to the Tx of NEO6GPS.
#define TXD_GPS             26 //17 // 17 Both Input and Output OK ////12 // Confirmed. Connected to the Rx of NEO6GPS.
//
// 13, 14, 26, 27.
//
...
#define BUTTON1             13
#define BUTTON2             14
#define BUTTON3             33 //26
#define BUTTON4             32 //27
//
